<?php
    ...
    <h1 style="font-size: 30px;font-family: 'Oxygen', sans-serif">Spisak sadržaja</h1>
        ...
        <button type="button" class="padajuci"><h2><i class="fas fa-sun"></i>Dodatni materijal</h2></button>
        <div class="dodatniMaterijal">
        <div class="dodatno materijal"><i class="far fa-smile-beam"></i>Stripovi</div>
        <div class="dodatno materijal"><i class="far fa-smile-beam"></i>Crtani filmovi</div>
        <div class="dodatno materijal"><i class="far fa-smile-beam"></i>Igre</div>
        </div>
    </div>
    <div class="sadrzaj sadrzaj-engleski" id="rezultatAjaxa">
    </div>
    <footer>
