            ...
            <div id="nav-container" class="container">
                ...
                <div id="nasMeni" class="collapse navbar-collapse">
                    <ul id="lista" class="nav navbar-nav ml-auto">
                        ...
                        <li><a href="kursevi.php"><i class="fas fa-graduation-cap"></i> <br class="d-none d-lg-block">KURSEVI</a></li>
                        ...
                        <li><a href="odjava.php"><i class="fas fa-sign-out-alt"></i> <br class="d-none d-lg-block">ODJAVA</a></li>
                    </ul>
                </div>
            </div>
        </nav>
